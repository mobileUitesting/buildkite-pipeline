...
// Find views by ID
        ...
        // Set click listener for Twitter icon
...
//                }
    ...
    private void setListeners() {
      binding.twitterIV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebsite("https://x.com/?lang=en");
            }
        });

        // Set click listener for Facebook icon
        binding.FacebookIV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openWebsite("https://www.facebook.com/?_rdr");
            }
        });

        binding.LinkedInIV.setOnClickListener(  new View.OnClickListener()            {
        @Override
        public void onClick(View v) {
            openWebsite("https://in.linkedin.com/");
        }
                }
        );
    }
